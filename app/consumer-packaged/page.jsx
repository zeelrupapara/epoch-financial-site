  ...
  return (
    <>
      ...
      <section className="bg-white pt-8 2xl:px-6 lg:px-16 md:px-12 px-4">
        <div className="mx-auto max-w-[1600px]">
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgb(11 35 65 / 72%), rgb(11 35 65 / 88%)), url("/assets/images/consumerpackage.jfif")',
            }}
          >
          ...
          <FadeUp delay={140}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-white/10 mb-12">
              <div className="flex flex-col items-center text-center px-8 py-6">
                <span className="text-primary xl:text-[48px] lg:text-[38px] text-[32px] font-black leading-none mb-2">Up To $100M+</span>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgb(11 35 65 / 92%), rgb(11 35 65 / 96%)), url("/assets/images/warehouse.jpg")',
        }}
      >
