...
const capitalSolutions = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1536240478700-b869ad10e128?auto=format&fit=crop&w=900&q=80",
  },
  {
...
const segments = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1536240478700-b869ad10e128?auto=format&fit=crop&w=1200&q=80",
  },
  {
  ...
  return (
    <>
      ...
      <section className="bg-white pt-8 2xl:px-6 lg:px-16 md:px-12 px-4 mb-8 xl:mb-16">
        <div className="mx-auto max-w-[1600px]">
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgb(17 55 95 / 55%), rgb(17 55 95 / 82%)), url("https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1600&q=80")',
            }}
          >
            <div
      ...
      <CTABanner
        ...
        bgImage="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1600&q=80"
      />
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-20">
            ...
            <FadeUp className="lg:w-[35%] lg:sticky lg:top-28 shrink-0 flex flex-col gap-6">
              ...
              <div className="relative rounded-2xl overflow-hidden" style={{ minHeight: 260 }}>
                <img
                  src="https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?auto=format&fit=crop&w=900&q=80"
      ...
      <CTABanner
        ...
        bgImage="https://images.unsplash.com/photo-1611532736597-de2d4265fba3?auto=format&fit=crop&w=1600&q=80"
      />
