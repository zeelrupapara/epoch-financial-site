      ...
      <section className="bg-white pt-8 2xl:px-6 lg:px-16 md:px-12 px-4 mb-8 xl:mb-16">
        <div className="mx-auto max-w-[1600px]">
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgb(11 35 65 / 75%), rgb(11 35 65 / 90%)), url("/assets/images/contact-hero.jpg")',
            }}
          >
            <div
            ...
            <FadeUp>
              <div className="flex flex-col gap-8">
                ...
                <div className="rounded-2xl bg-primary/5 border border-primary/15 p-6">
                  ...
                  <p className="text-body-gray text-sm leading-relaxed">
                    We structure credit facilities <span className="text-primary font-semibold">up to $100M+</span> for middle market companies with at least $15M+ in annual revenues.
                  </p>
                </div>
              </div>
            </FadeUp>
