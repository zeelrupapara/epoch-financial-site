            ...
            <FadeUp>
              <div className="flex flex-col gap-8">
                ...
                <div className="rounded-2xl bg-primary/5 border border-primary/15 p-6">
                  ...
                  <p className="text-body-gray text-sm leading-relaxed">
                    We structure credit facilities from <span className="text-primary font-semibold">$5M to $150M+</span> for middle market companies with at least $10M in annual revenues.
                  </p>
                </div>
              </div>
            </FadeUp>
